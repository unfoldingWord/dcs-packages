...
export const IssueApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} [createdBy] filter (issues / pulls) created to
         * @param {string} [assignedBy] filter (issues / pulls) assigned to
         * @param {string} [mentionedBy] filter (issues / pulls) mentioning to
         * @param {number} [page] page number of results to return (1-based)
         * @param {number} [limit] page size of results
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        issueListIssues: async (owner: string, repo: string, state?: string, labels?: string, q?: string, type?: string, milestones?: string, since?: Date, before?: Date, createdBy?: string, assignedBy?: string, mentionedBy?: string, page?: number, limit?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'owner' is not null or undefined
            if (owner === null || owner === undefined) {
         ...
         * @throws {RequiredError}
         */
        issueSearchIssues: async (state?: string, labels?: string, milestones?: string, q?: string, priorityRepoId?: number, type?: string, since?: Date, before?: Date, assigned?: boolean, created?: boolean, mentioned?: boolean, reviewRequested?: boolean, page?: number, limit?: number, options: any = {}): Promise<RequestArgs> => {
...
export const IssueApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async issueListIssues(owner: string, repo: string, state?: string, labels?: string, q?: string, type?: string, milestones?: string, since?: Date, before?: Date, createdBy?: string, assignedBy?: string, mentionedBy?: string, page?: number, limit?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Issue>>> {
         ...
         * @throws {RequiredError}
         */
        async issueSearchIssues(state?: string, labels?: string, milestones?: string, q?: string, priorityRepoId?: number, type?: string, since?: Date, before?: Date, assigned?: boolean, created?: boolean, mentioned?: boolean, reviewRequested?: boolean, page?: number, limit?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Issue>>> {
            const localVarAxiosArgs = await IssueApiAxiosParamCreator(configuration).issueSearchIssues(state, labels, milestones, q, priorityRepoId, type, since, before, assigned, created, mentioned, reviewRequested, page, limit, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const IssueApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        issueListIssues(owner: string, repo: string, state?: string, labels?: string, q?: string, type?: string, milestones?: string, since?: Date, before?: Date, createdBy?: string, assignedBy?: string, mentionedBy?: string, page?: number, limit?: number, options?: any): AxiosPromise<Array<Issue>> {
         ...
         * @throws {RequiredError}
         */
        issueSearchIssues(state?: string, labels?: string, milestones?: string, q?: string, priorityRepoId?: number, type?: string, since?: Date, before?: Date, assigned?: boolean, created?: boolean, mentioned?: boolean, reviewRequested?: boolean, page?: number, limit?: number, options?: any): AxiosPromise<Array<Issue>> {
            return IssueApiFp(configuration).issueSearchIssues(state, labels, milestones, q, priorityRepoId, type, since, before, assigned, created, mentioned, reviewRequested, page, limit, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Start stopwatch on an issue.
...
export class IssueApi extends BaseAPI {
     ...
     * @memberof IssueApi
     */
    public issueListIssues(owner: string, repo: string, state?: string, labels?: string, q?: string, type?: string, milestones?: string, since?: Date, before?: Date, createdBy?: string, assignedBy?: string, mentionedBy?: string, page?: number, limit?: number, options?: any) {
     ...
     * @memberof IssueApi
     */
    public issueSearchIssues(state?: string, labels?: string, milestones?: string, q?: string, priorityRepoId?: number, type?: string, since?: Date, before?: Date, assigned?: boolean, created?: boolean, mentioned?: boolean, reviewRequested?: boolean, page?: number, limit?: number, options?: any) {
        return IssueApiFp(this.configuration).issueSearchIssues(state, labels, milestones, q, priorityRepoId, type, since, before, assigned, created, mentioned, reviewRequested, page, limit, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Start stopwatch on an issue.
